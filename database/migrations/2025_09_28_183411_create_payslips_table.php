...
return new class extends Migration {
  ...
  public function up(): void
  {
    Schema::create('payslips', function (Blueprint $table) {
      ...
      $table->json('tax_deductions')->nullable(); // Store detailed tax breakdown
      $table->decimal('total_tax_deductions', 10, 2)->default(0);
      $table->json('other_deductions')->nullable(); // Store other deductions
      $table->decimal('total_other_deductions', 10, 2)->default(0);
      $table->decimal('net_pay', 10, 2)->default(0);
      $table->json('bonuses')->nullable(); // Store bonuses if any
      ...
      $table->json('metadata')->nullable(); // Store additional payroll data
      $table->timestamps();
