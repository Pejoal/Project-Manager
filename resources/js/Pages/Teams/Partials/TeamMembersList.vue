...
<template>
  <ActionSection class="mt-10 sm:mt-0">
    <template #title>{{ trans('words.team_members') }}</template>

    <template #description>{{ trans('words.team_members_description') }}</template>
  ...
  <DialogModal :show="currentlyManagingRole" @close="currentlyManagingRole = false">
    <template #title>{{ trans('words.manage_role') }}</template>
    ...
    <template #footer>
      <SecondaryButton @click="currentlyManagingRole = false">{{ trans('words.cancel') }}</SecondaryButton>
  ...
  <ConfirmationModal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
    <template #title>{{ trans('words.leave_team') }}</template>

    <template #content>{{ trans('words.leave_team_confirmation') }}</template>

    <template #footer>
      <SecondaryButton @click="confirmingLeavingTeam = false">{{ trans('words.cancel') }}</SecondaryButton>
  ...
  <ConfirmationModal :show="teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
    <template #title>{{ trans('words.remove_team_member') }}</template>

    <template #content>{{ trans('words.remove_team_member_confirmation') }}</template>

    <template #footer>
      <SecondaryButton @click="teamMemberBeingRemoved = null">{{ trans('words.cancel') }}</SecondaryButton>
