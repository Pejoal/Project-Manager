...
<template>
  <Head title="Log Time" />
  <header>
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Create New Time Entry</h2>
  </header>
      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
        <form @submit.prevent="submit" class="p-6 space-y-6">
          ...
          <div class="flex justify-end">
            <PrimaryButton :disabled="form.processing">Log Time</PrimaryButton>
          </div>
        </form>
      </div>
    </div>
